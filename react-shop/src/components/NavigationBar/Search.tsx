...
const Search = () => {
  ...
  const menuClick: MouseEventHandler<HTMLUListElement> = (e) => {
  ...
  return (
    <div className="dropdown">
      ...
      {filteredDatas.length > 0 && 
        (<ul onClick={(e) => menuClick(e)} className="!fixed left-0 sm:!absolute sm:top-14 menu dropdown-content w-full sm:w-64 max-h-96 shadow text-base-content overflow-y-auto bg-white dark:bg-gray-600">
